...
?>
    ...
    <dt>
    	<?php print $title; ?> <?php if ($description) { print $description; } ?>
    </dt>
    <dd class="clearfix">
        <?php if ($preis_studi | $preis_normal): ?> 
        	<span class="t-right"><?php print $preis_studi ?> | <?php print $preis_normal ?></span>
        <?php endif; ?>
    </dd>
