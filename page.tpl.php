...
?>
    ...
    <div class="grid-container">
        ...
        <?php if ($page['navigation_mobile']): ?>
            <nav id="mobile">
                <?php print render($page['navigation_mobile']); ?>
            </nav>
        <?php endif; ?>

        <?php /* Mobile Navigation Top Header */ ?>
        <?php if ($page['navigation_mobile_top']): ?>
            <nav id="mobile_top">
                <?php print render($page['navigation_mobile_top']); ?>
            </nav>
        <?php endif; ?>

        <div id="main" class="row-fluid content">
            <div id="logo" class="hide-text clearfix">
                <h1>Q-West</h1>
            </div>


            <?php /* Haupt Navigation */ ?>
            <?php if ($main_menu): ?>
            <nav id="basic" class="grid-100">
                <?php
